...
{
    public partial class DisitrubutionFromSpreadsheet : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
                ...
                {
                    this.Title = "Distribution Analysis: " + DistributionAnalysis.RetrieveDistributionDescription(id);

                    this.GridView1.DataSource = SpreadsheetPaste.GetDataTable(DistributionAnalysis.RetrieveDistributionData(id), true);
        ...
        private void fillDistributionDDL()
        {
            ...
            ddlDChoice.DataSource = DistributionData.typesAsSortedList();
        ...
        protected void btnSaveData_Click(object sender, EventArgs e)
        {
            ...
            DistributionAnalysis.InsertDistribution(DistributionAnalysis.RetrieveDistributionDescription(id), d, UserLogin.getUserID(Session));
        }
        ...
        {
            double[] v = new double[SMADA_2012.App_Code.SMADA.DistributionData.MAXDATA];
            int c = Convert.ToInt32(ddlTitle.SelectedValue);
            int n = getValuesFromGrid(c, v);

            DistributionData dd = new DistributionData(n, v);
