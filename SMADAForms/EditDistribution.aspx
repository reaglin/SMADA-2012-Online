<%@ Page Title="Enter/Edit Distribution Data" Language="C#" MasterPageFile="~/ISRID.Master" AutoEventWireup="true" CodeBehind="EditDistribution.aspx.cs" Inherits="SMADA_2012.SMADAForms.EditDistribution" %>
...
Enter Data:<br />
    <asp:TextBox ID="tbData" runat="server" ClientIDMode="Static" TextMode="MultiLine"  
     Height="400" Width="600" Wrap="false" />
    <br /><br />
...
by a space, tab, comma, or semicolon. When the data is saved these will all be converted to tab characters. <br /><br />
    <asp:TextBox ID="tbSample" runat="server" TextMode="MultiLine"  Height="100" Width="300" Enabled="false"/>
    <br /><br />
