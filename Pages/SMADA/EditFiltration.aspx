<%@ Page Title="Biofiltration" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditFiltration.aspx.cs" 
    Inherits="SMADA2013.Pages.SMADA.EditFiltration" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
                  ...
                  <tr>
                    ...
                    <tr>
                        ...
                        <td class="TableEntryCell">
                            <asp:DropDownList ID="ddlMediaMix" runat="server" CssClass="DropDownList"></asp:DropDownList>
                        </td>
                    </tr>
                    ...
                    <tr> 
                        <td colspan='2'>
                         ...
                         <asp:Button ID="btnCalculate" runat="server" Text="Calculate" OnClick="btnCalculate_Click" CausesValidation="false" CssClass="FormButton" />
                            <uc1:ucHelpPopup runat="server" ID="ucHelpPopup" ObjectClass="Filtration" Image="~/Images/Filtration.png"/>
    ...
    <table style="margin: 0% 0% 0% 5%;">
        <tr>
            <td>
                <uc1:ucOutputXmlPropertyObject runat="server" ID="ucOutputXmlPropertyObject"  Image="~/Images/Filtration.png" />
            </td>
        </tr>
        <tr>
            <td>
                ...
                <uc1:ucHelpPopup runat="server" ID="ucHelpPopup1" ObjectClass="Filtration" Image="~/Images/Filtration.png"/>
