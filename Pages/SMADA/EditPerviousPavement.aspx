<%@ Page Title="Pervious Pavement" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditPerviousPavement.aspx.cs" 
    Inherits="SMADA2013.Pages.SMADA.EditPerviousPavement" ValidateRequest="false" %>
...
<%@ Register Src="~/UserControls/ucEnterPavement.ascx" TagPrefix="uc1" TagName="ucEnterPavement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
        ...
        <br/>
              <table style="margin: 0% 0% 0% 5%;">
                  ...
                  <tr>
                    ...
                    <tr>
                        <td class="TableLabelCell">
                            Enter Pervious Pavement<br/>
                            Thicknesses (in)<br/><br/>
                            Select Custom List:<br/>
                            <asp:DropDownList ID="ddlList" runat="server" CssClass="DropDownList" AutoPostBack="true" OnSelectedIndexChanged="ddlList_SelectedIndexChanged"></asp:DropDownList><br/>
                         <asp:Button ID="btnTypes" runat="server" Text="Edit Types" OnClick="btnTypes_Click" CssClass="FormButton" CausesValidation="False" />

                        </td>
                        <td class="TableEntryCell">
                            <uc1:ucEnterPavement runat="server" id="ucEnterPavement" />
                        </td>
                    </tr>
                    ...
                    <tr> 
                        <td colspan='2'>
                         ...
                         <uc1:ucHelpPopup runat="server" ID="ucHelpPopup" ObjectClass="PerviousPavement" Image="~/Images/PerviousPavement.png"/>
    ...
    <table style="margin: 0% 0% 0% 5%;">
        <tr>
            <td>
                <uc1:ucOutputXmlPropertyObject runat="server" ID="ucOutputXmlPropertyObject" Image="~/Images/PerviousPavement.png" />
            </td>
        </tr>
        <tr>
            <td>
               ...
               <uc1:ucHelpPopup runat="server" ID="ucHelpPopup1" ObjectClass="PerviousPavement" Image="~/Images/PerviousPavement.png"/>
