<%@ Page Title="Calculate Wet Detention Pond Pollutant Removal Efficiency" Language="C#" MasterPageFile="~/Site.Master" 
    AutoEventWireup="true" CodeBehind="EditWetDetention.aspx.cs" 
    Inherits="SMADA2013.Pages.SMADA.EditWetDetention" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
                  ...
                  <tr>
                    ...
                    <tr> 
                        <td colspan='2'>
                         ...
                         <uc1:ucHelpPopup runat="server" ID="ucHelpPopup" ObjectClass="WetDetention" Image="~/Images/WetDetention2.png"/>
    ...
    <table style="margin: 0% 0% 0% 5%;">
        ...
        <tr><td><br/>
               ...
               <uc1:ucHelpPopup runat="server" ID="ucHelpPopup1" ObjectClass="WetDetention" Image="~/Images/WetDetention2.png"/>
