<%@ Page Title="Stormwater Harvesting" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditHarvesting.aspx.cs" 
    Inherits="SMADA2013.Pages.SMADA.EditHarvesting" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FeaturedContent" runat="server">
                  ...
                  <tr>
                    ...
                    <tr> 
                        <td colspan='2'>
                         ...
                         <uc1:ucHelpPopup runat="server" ID="ucHelpPopup" ObjectClass="Retention" Image="~/Images/Harvesting.png"/>
    ...
    <table style="margin: 0% 0% 0% 5%;">
        <tr>
            <td>
                <uc1:ucOutputXmlPropertyObject runat="server" ID="ucOutputXmlPropertyObject"  Image="~/Images/Harvesting.png" />
            </td>
        </tr>
        <tr>
            <td>
               ...
               <uc1:ucHelpPopup runat="server" ID="ucHelpPopup1" ObjectClass="Retention" Image="~/Images/Harvesting.png"/>
